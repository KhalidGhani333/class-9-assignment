    ...
    <>
      {/* <div className='w-[1920px]  h-[812.09px] py-[140px] px-[220px] flex  flex-row-reverse items-center gap-[98px] bg-[#FFFFFF]'>
       ...
       <div className='w-[669px] h-[288px] gap-[24px] '>
          ...
          to your needs</h2>
          <p className='w-[669px] pt-6 h-[90px] text-lg font-normal leading-[30px] tracking-[-2%] text-left text-[#212529]'>Customise the app with plugins, custom themes and multiple text editors (Rich Text or Markdown). Or create your own scripts and plugins using the Extension API.</p>
       </div>
